...
#include "stdafx.h"
#include "spitonicdelaysynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicdelaysynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicdelaysynthvoroguiwin32class"};				// the main window class name
